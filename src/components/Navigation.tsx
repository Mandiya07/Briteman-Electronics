        ...
        <div className="flex justify-between h-18">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              {/* Single Sign In / Account Controller */}
              {currentUser ? (
                <div className="flex items-center space-x-2 bg-slate-100 dark:bg-slate-900 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-800">
                  <div className="text-left hidden sm:block">
                    <p className="text-[10px] font-bold text-slate-900 dark:text-white truncate max-w-[130px]">{currentUser.email}</p>
                    <p className="text-[8px] text-emerald-500 font-mono font-semibold">
                      {currentUser.email?.toLowerCase() === 'ajapresd@gmail.com' ? '👑 Admin Superuser' : '● Verified User'}
                    </p>
                  </div>
                  ...
                  {currentUser.email?.toLowerCase() === 'ajapresd@gmail.com' && (
                    <button
                      ...
                      className={`px-2.5 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider transition cursor-pointer flex items-center space-x-1 ${
                        currentTab === 'admin'
                          ? 'bg-primary text-white shadow-sm'
                          : 'bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700'
                      }`}
                  ...
                  <button
                    onClick={onLogout}
                    className="text-[10px] font-bold uppercase tracking-wider text-red-500 hover:text-red-700 bg-red-50 dark:bg-red-950/40 px-2 py-1.5 rounded-lg transition cursor-pointer"
                    title="Sign Out"
                  >
                    Logout
                  </button>
                ...
                <button
                  onClick={onLogin}
                  className="bg-primary hover:bg-primary-hover text-white text-[11px] font-bold px-4 py-2.5 rounded-xl transition flex items-center space-x-2 cursor-pointer shadow-sm"
              ...
              <div className="pt-2 space-y-3">
                ...
                {currentUser ? (
                  <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 space-y-3">
                    ...
                    {currentUser.email?.toLowerCase() === 'ajapresd@gmail.com' && (
                      <button
                        ...
                        className="w-full bg-slate-900 dark:bg-slate-800 text-white py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center space-x-1.5"
                      >
                        <User className="h-4 w-4" />
                    ...
                    <button
                      ...
                      className="w-full bg-red-50 dark:bg-red-950/40 text-red-500 hover:bg-red-100 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition"
                    >
                      Sign Out
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-primary hover:bg-primary-hover text-white py-3.5 rounded-2xl text-xs font-bold uppercase tracking-wider flex items-center justify-center space-x-2 shadow-lg"
                  >
                    <User className="h-4 w-4" />
